...
class DataStrokes
{
    ...
    public static $meanings = [
        ...
        [
            "images" => [
                "https://media.kanjialive.com/kanji_strokes/den-ta_1.svg",
                "https://media.kanjialive.com/kanji_strokes/den-ta_2.svg",
                "https://media.kanjialive.com/kanji_strokes/den-ta_3.svg",
                "https://media.kanjialive.com/kanji_strokes/den-ta_4.svg",
                "https://media.kanjialive.com/kanji_strokes/den-ta_5.svg"
            ]
        ],
        '雨' =>
        [
        ...
        [
            ...
            'examples' => [
                "帽子 (ぼうし)" => [
                    "english" => "hat, cap",
                    "spanish" => "sombrero, gorra",
                ],
                "電子レンジ (でんしレンジ)" => [
                    "english" => "microwave oven",
                    "spanish" => "horno de microondas",
                ],
                "調子 (ちょうし)" => [
                    "english" => "pitch, mood, condition",
                    "spanish" => "tono, estado de ánimo, condición",
                ],
                "菓子屋 (かしや)" => [
                    "english" => "candy shop",
                    "spanish" => "dulcería",
                ...
                "養子 (ようし)" => [
                    ...
                    "spanish" => "niño adoptado",
                ],
                "利子 (りし)" => [
                    "english" => "interest (bank)",
                    "spanish" => "interés (banco)",
                ],
                "椅子 (いす)" => [
                    "english" => "chair",
                    "spanish" => "silla",
        ...
        [
            ...
            'examples' => [
                ...
                "日本人 (にほんじん)" => [
                    ...
                    "spanish" => "persona japonesa",
                ],
                "御主人 (ごしゅじん)" => [
                    "english" => "someone's husband",
                    "spanish" => "el marido de alguien",
                ],
                "人間 (にんげん)" => [
                    "english" => "human",
                    "spanish" => "humano",
